    ...
    <div className="min-h-screen bg-gray-200 flex flex-col lg:flex-row items-center justify-center gap-8 p-8">
      ...
      <article className="relative bg-white rounded-[40px] shadow-xl overflow-hidden w-[340px] h-[600px] border-8 border-white">
        <figure className="relative h-full overflow-hidden">
          ...
          <figcaption className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent px-6 pt-6 pb-6">
            <h2 className="text-white text-3xl font-bold mb-1">New York</h2>
            <p className="text-gray-400 text-sm mb-4">Economy</p>
            ...
            <button className="w-full bg-white text-gray-800 py-3 px-6 rounded-full font-semibold text-base">
              Search flight
            </button>
          </figcaption>
        </figure>
      ...
      <article className="relative bg-white rounded-[40px] shadow-xl overflow-hidden w-[340px] h-[600px] border-8 border-white flex flex-col">
        ...
        <section className="px-6 pt-4 pb-6 flex-1 flex flex-col">
          ...
          <ul className="flex items-center gap-4 text-gray-500 text-sm mb-6 list-none">
            <li className="flex items-center gap-2">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
              </svg>
          ...
          <nav className="flex items-center gap-3 mt-auto">
            <button className="flex-1 bg-gray-900 text-white py-3 px-6 rounded-full font-semibold text-base">
              Search flight
            </button>
            <button className="w-12 h-12 bg-white border-2 border-gray-100 rounded-full flex items-center justify-center">
